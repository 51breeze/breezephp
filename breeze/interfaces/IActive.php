...
interface IActive
{
    ...
    */
     ...
     * @param string $type=‘AND’ 在使用比较多个条件时是使用 "AND | OR | <>" 的表达式。如果 $column 是一个数组并且 $value===null 则允许是一个数组。
     * @return \breeze\database\Whereis
    */
    public function where( $column ,$value=null ,$strainer=Strainer::EQUAL, $type='AND' );
