...
class Lang implements ISingle
{
    ...
    {
        return Single::register(get_called_class(),$param);
    }
   ...
   private function loadDefault()
   {
       ...
       {
           $this->default=Utils::import('\breeze\core\ErrorInfo');
   ...
   private function language( $lang )
   {
    ...
    {
        $lang=Single::getInstance('\breeze\core\Lang');
        $info=$lang->get( $code );
