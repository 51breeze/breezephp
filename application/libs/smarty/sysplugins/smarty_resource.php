...
abstract class Smarty_Resource
{
    ...
    /**
     * Name of the Class to compileTemplate this resource's contents with
     * @var string
     */
     ...
     * @param  string $resource_name    template_resource or config_resource to compileTemplate
    ...
    public static function source(Smarty_Internal_Template $_template=null, Smarty $smarty=null, $template_resource=null)
    {
        ...
        // compileTemplate resource_name, load resource handler, identify unique resource name
