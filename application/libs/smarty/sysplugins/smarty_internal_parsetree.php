...
class _smarty_tag extends _smarty_parsetree
{
    ...
    /**
     * Create compileTemplate tree buffer for Smarty tag
     *
...
{
    /**
     * Create compileTemplate tree buffer for code fragment
     *
     * @param object $parser parser object
     * @param string $data   content
     */
...
{
    /**
     * Create compileTemplate tree buffer for double quoted string subtrees
     *
     * @param object            $parser  parser object
...
{
    /**
     * Create compileTemplate tree buffer with string content
     *
     * @param object $parser parser object
...
class _smarty_template_buffer extends _smarty_parsetree
{
    ...
    /**
     * Create root of compileTemplate tree for template elements
     *
     * @param object $parser compileTemplate object
     */
